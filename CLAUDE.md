...
- Read any `AgenteXX_*/` folder from Agente00 through Agente08 as reference implementations for fully-built agents — `Agente04_DevBackend/` and `Agente07_DevSecOps/` are particularly comprehensive
