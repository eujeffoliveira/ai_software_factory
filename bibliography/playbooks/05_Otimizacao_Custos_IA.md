...
- Errado: "Melhore este codigo"
- Correto: "Extraia a funcao validateEmail para utils/validation.ts"

### 3. Dividir Tarefas Grandes
- Errado: "Implemente todo o modulo de autenticacao"
- Correto: Dividir em: schema → migration → service → middleware → testes
